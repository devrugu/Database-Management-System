...
<head>
    ...
    <link rel="stylesheet" href="style-sqlsorgulasafasiilk.css">
    ...
    <h2>Veritabanı Üzerinde SQL Komutu Koş</h2>
    ...
    <div class="form">
      <form action="../includes/SQLsorgulamaYonet.inc.php" method="POST">
        <div class="inputs">
          ...
          <?php
            if (isset($_GET['sqlsorgula'])) {
              ...
              echo '<textarea  id="sqlsorgula" name="sqlsorgula" placeholder="Veritabanında sorgulama yapmak için SQL komutu (MariaDB syntax) giriniz..." rows="15" cols="100" value="'.$sqlsorgula.'"></textarea>';
              } else {
              echo '<label for="sqlsorgula">SQL sorgula</label>';
              echo '<textarea  id="sqlsorgula" name="sqlsorgula" placeholder="Veritabanında sorgulama yapmak için SQL komutu (MariaDB syntax) giriniz..." rows="15" cols="100"></textarea>';
            }
          ?>
        ...
        <button name="sorgula">Sorgula</button>
        </div>
      ...
      if (!isset($_GET['signup'])) {
        exit();
          ...
          switch ($signupCheck) {
            ...
            break;
            case "sqlhata";
              echo "<p class='error'>Yazdığınız sorgu veritabanında herhangi bir döngü ile sonuçlanmadı (Doğru syntaxı kullandığınızdan emin olun)!</p>";
            break;

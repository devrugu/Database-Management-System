...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="style-hastalikBilgisiGoruntulemeSayfasii.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <title>Hastalık Bilgisi Görüntüle</title>
  </head>

  <body>

    <br><br><br><br><br>
    <h2>Hastalık Bilgisi Görüntüle</h2>
    <br><br><br><br><br>
      ...
      <form action="../../includes/hastalikBilgisiYonet.inc.php" method="POST">
        <div class="inputs">
            ...
            <select class="input" name="tcno" id="tcno">
                <option value="default">Hastalık bilgisi görüntülemek için TC no seçiniz</option>

...
<head>
    ...
    <link rel="stylesheet" href="style-covidBilgisiEkleme.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <title>Covid Bilgisi Ekle</title>
</head>
<body>
...
<div class="ciftgeri">
    ...
    <header>
        <nav>
            <ul class="nav__links">
                ...
                <li class="geri" onclick=location.href='../covidBilgisiYonet-sayfasi.php'><a href="#">Geri</a></li>
            </ul>
        </nav>
    </header>

    
    <h2>Covid Bilgisi Ekle</h2>
      ...
      <form action="../../includes/covidBilgisiYonet.inc.php" method="POST">
        <div class="inputs">
            ...
            <select class="input" name="tcno" id="tcno">
                <option value="default">Covid bilgisi eklemek için TC no seçiniz</option>
    ...
    <form action="covidSemptomEkle/covidSemptomEkle-sayfasi.php">
        <button class="semptomekle">Semptom ekle</button>
    </form>

    <form action="covidTemasliEkle/covidTemasliEkle-sayfasi.php">
        <button class="temaslibilgisiekle">Temaslı bilgisi ekle</button>
    </form>
   </div>

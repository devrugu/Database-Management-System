...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="style-covidBilgisiGoruntulemeSayfasii.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <title>Covid Bilgisi Görüntüle</title>
  </head>

  <body>

    <br><br><br><br><br>
    <h2>Covid Bilgisi Görüntüle</h2>
    <br><br><br><br><br>
      ...
      <form action="../../includes/covidBilgisiYonet.inc.php" method="POST">
        <div class="inputs">
            ...
            <select class="input" name="tcno" id="tcno">
                <option value="default">Covid bilgisi görüntülemek için TC no seçiniz</option>
        ...
        <button name="view">Görüntüle</button>
      ...
      if (!isset($_GET['signup'])) {
        exit();
          ...
          switch ($signupCheck) {
            ...
            break;
            case "veritabanı";
              echo "<p class='error'>Veritabanında bu kişiye ait bir kayıt bulunmamaktadır!</p>";
            break;
